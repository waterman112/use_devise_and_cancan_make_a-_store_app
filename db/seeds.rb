...
i1 = Item.create({name: "Rayban Sunglasses", description: "Stylish shades",user_id: u2.id})
i2 = Item.create({name: "Gucci watch", description: "Expensive timepiece", user_id: u2.id})
i3 = Item.create({name: "Henri Lloyd Pullover", description: "Classy knitwear", user_id: u3.id})
i4 = Item.create({name: "Porsche socks", description: "Cosy footwear", user_id: u3.id})
